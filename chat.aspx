<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chat.aspx.cs" Inherits="MatchingCoffees.chat" %>
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Matchingcoffees - Chat</title>
    </head>
<body>
            ...
            <div class="main-content">
               <div class="messages-view">
                <div class="message-header">
                    <img src="./assets/images/profiles/<%= toUser_ProfilePicture %>" height="30px">
                    <p><%= toUser_First_Name %> <%= toUser_Last_Name %></p>
                </div>
                <div class="messages" id="messages_container" runat="server">
                </div>
                <form runat="server" method="post" style="display:flex; align-items:center">
               <asp:TextBox ID="TXT_msg" runat="server" Rows="3"></asp:TextBox>
