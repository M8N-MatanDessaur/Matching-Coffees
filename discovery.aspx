<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discovery.aspx.cs" Inherits="MatchingCoffees.discovery" %>
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <title>Matchingcoffees - Discover</title>
    </head>
<body>
    <section class="discover">
        <nav class="left-side-navigation not-on-mobile">
            ...
            <ul>
                <li><a href="./discovery.aspx" class="selected">Discover</a></li>
                <li><a href="./messenger.aspx">Messages</a></li>
        ...
        <main class="main-area">
            <header class="ribbon">
                <form runat="server" class="filters">
                    <asp:DropDownList ID="filter_coffees" runat="server" OnSelectedIndexChanged="filter_coffees_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                    <asp:DropDownList ID="filter_wakehour" runat="server" OnSelectedIndexChanged="filter_wakehour_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                </form>
